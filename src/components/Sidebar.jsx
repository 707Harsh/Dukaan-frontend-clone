import {PiHouse, PiSquaresFour} from "react-icons/pi";

import {LuClipboardList, LuUsers} from "react-icons/lu";

import {RiMegaphoneLine, RiDiscountPercentLine} from "react-icons/ri";
...
const items = [
    {title:'Home',icon:<PiHouse className=" h-7 w-7" />}, 
    {title:'Orders',icon:<LuClipboardList className=" h-7 w-7"/>}, 
    {title:'Products',icon:<PiSquaresFour className=" h-7 w-7"/>},
    {title:'Delivery',icon:<BsTruck className=" h-7 w-7"/>},
    {title:'Marketing',icon:<RiMegaphoneLine className=" h-7 w-7"/>},
    {title:'Analytics',icon:<GrAnalytics className=" h-7 w-7"/>}, 
    {title:'Payouts',icon:<TbCash className=" h-7 w-7"/>}, 
    {title:'Discounts',icon:<RiDiscountPercentLine className=" h-7 w-7"/>}, 
    {title:'Audience',icon:<LuUsers className=" h-7 w-7"/>}, 
    {title:'Appearence',icon:<MdOutlineColorLens className=" h-7 w-7"/>}, 
    ...
    return(
        <div className="bg-sb-blue h-screen w-0 md:w-64 duration-300 text-white">
            ...
            <div className="mt-5 hidden md:block">
                <ul className="px-1.5">
                    {items.map((item,index)=>{return <li className='flex font-medium text-slate-300 items-center p-2 mx-2 rounded hover:bg-slate-700 cursor-pointer' key={index}>{item.icon}<div className=" ml-3">{item.title}</div></li>})}
                </ul>
            </div>
        </div>
    )
